...
export const useSmoothScroll = (enabled: boolean = true) => {
  useEffect(() => {
    ...
    // Configurações do smooth scroll
    const smoothness = 0.08; // Menor = mais suave (0.05-0.15 é ideal)
    const scrollMultiplier = 1.2; // Multiplicador da velocidade do scroll
