...
const MaterialCheckout: React.FC = () => {
  ...
  // Compra sem login com e-mail que já tem conta — ver Checkout.tsx (cursos):
  // a pessoa escolhe entre liberar o material na conta existente ou receber o
  ...
  // Verifica, com atraso, se o e-mail digitado já pertence a uma conta.
  useEffect(() => {
    if (isAuthenticated) {
        ...
        <div className="lg:col-span-3 space-y-6">
          <GlassCard className="p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* E-mail com conta existente: escolha de como receber o acesso */}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[var(--color-text-muted)] mt-0.5">
                        Escolha como quer receber o acesso a este material:
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-sm">
                      ...
                      <span className="block text-xs text-[var(--color-text-muted)] mt-1">
                        O material fica salvo em "Meus Materiais" ao entrar com este e-mail.
                      </span>
                    </span>
                  </label>
                  ...
                  >
                    ...
                    <span className="text-sm">
                      <span className="flex items-center gap-2 font-medium text-[var(--color-text-primary)]">
                        ...
                        Receber o código de acesso por e-mail
                      </span>
                      <span className="block text-xs text-[var(--color-text-muted)] mt-1">
                        Enviamos o link e o código de acesso, sem vincular a nenhuma conta.
                      </span>
                    </span>
                  </label>
                </div>
