...
const Privacy: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 animate-fade-in">
      <Link to="/" className="inline-flex items-center gap-2 text-[var(--color-text-secondary)] hover:text-primary-500 mb-8">
        <ArrowLeft className="w-4 h-4" />
        Voltar
      </Link>

      <h1 className="font-heading text-3xl font-bold text-[var(--color-text-primary)] mb-8">Política de Privacidade</h1>
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-[var(--color-text-secondary)] mb-4">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-[var(--color-text-secondary)]">
